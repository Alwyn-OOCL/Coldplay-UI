    ...
    <section className="homeposter">
      <div className="container homeposter-container">
        <div className="homeposter-content">
          ...
          <p className="homeposter-subtitle">
            Join us for an unforgettable journey as Coldplay takes the stage
            across the globe.
          </p>
          <button className="button button-primary" onClick={handleGetTicket}>
            Get Tickets
          </button>
        </div>
