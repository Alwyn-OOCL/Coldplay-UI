    ...
    return (
        <div className="filter-options">
            <div className="filter-field">
                ...
                {filters.country && <button type="button" onClick={clearCountry}>X</button>}
            </div>
            ...
            <div className="filter-field">
                ...
                <datalist id="cityList">
                    {filteredCities.map(ci => <option key={ci} value={ci} />)}
                </datalist>
                {filters.city && <button type="button" onClick={clearCity}>X</button>}
            </div>
            ...
            <div className="filter-field">
                ...
                <datalist id="venueList">
                    {filteredVenues.map(v => <option key={v} value={v} />)}
                </datalist>
                {filters.venue && <button type="button" onClick={clearVenue}>X</button>}
            </div>
